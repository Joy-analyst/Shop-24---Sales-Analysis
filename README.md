...
This project leverages **Microsoft Excel** to develop an interactive dashboard that summarizes **Shop’24’s** performance across revenue, profit, customers, transactions, and various business dimensions.
...
- Determine **Number of Customers** and **Number of Transactions**  
- Analyze performance by **region, state, supplier, gender, marital status, and product category**  
- Create a **dynamic and interactive Excel dashboard** for real-time decision-making  
...
- **Microsoft Excel**
  ...
  - Pivot Tables and Pivot Charts for aggregation and analysis  
  - Slicers and Timelines for interactivity  
  - Conditional Formatting for trend highlighting  
  - Advanced Formulas: `SUMIFS`, `COUNTIFS`, `VLOOKUP`, `IFERROR`, and `TEXT`  
...
### Explanation:
- **visuals/** – This folder holds images or screenshots of the dashboard so users can quickly see what it looks like without opening Excel.  
- **data/** – Contains the datasets that feed into the dashboard. Users can inspect the data or use it to test their own analyses.  
- **Shop24-Dashboard.xlsx** – The main interactive Excel dashboard file. This is the core of the project.  
- **README.md** – The documentation explaining the project, objectives, insights, and how to use it.  
...
## 📊 Dashboard Features
The Excel dashboard is designed to be **interactive and dynamic**, allowing users to:
- Filter data by **year (2023, 2024)**, **month**, and **product category**  
- Instantly view changes in metrics, charts, and trends  
- Explore relationships between customer demographics and purchase behavior  
- Track monthly sales progression for both years
...
- **Seasonal Trend:** Strong upward movement in later months of each year (Nov–Dec).  
...
- Optimize product stocking, marketing campaigns, and profit margins  
